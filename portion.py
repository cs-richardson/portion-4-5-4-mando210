"""
 This program computes how many tons of food each person in a group
 should take based on how many total tons of food the
 group has and how many people are in the group.
 It then asks the user how much food they took.
"""
#Miki Ando
